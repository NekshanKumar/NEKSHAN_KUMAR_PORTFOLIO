      ...
      <div className="container portfolio_container">
        ...
        <article className='portfolio_item'>
          ...
          <img src={IMG2}alt="" />
            ...
            <div className="portfolio_item-cta">
            <a href="https://github.com/NekshanKumar/Weather_Update" className='btn' target='_blank'>Github</a>
            <a href="https://nekshankumar.github.io/Weather_Update/" className='btn btn-primary' target='_blank' >Live Demo</a>
            </div>
          </div>
        </article>
